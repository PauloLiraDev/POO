...
Classes podem conter:
    ...
    computacionalmente os estados de um objeto. No caso da lâmpada, possivelmente iríamos querer saber a voltagem da
    lâmpada, a cor da luz, qual é a luminosidade dela, etc.
